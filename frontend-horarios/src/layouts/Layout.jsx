...
const Layout = ({ children }) => {
  ...
  const { user, logout, isAdmin, isCoordinador, isDocente } = useAuth();
  ...
  const navigation = [
    ...
    {
      name: 'Parrilla de Horarios',
      href: '/reportes/horarios',
      roles: [1, 2],
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-4 bg-gradient-to-r from-blue-600 to-blue-700">
            ...
            <button
              onClick={() => setSidebarOpen(false)}
              className="p-1 rounded-md text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-white"
            >
          ...
          <div className="border-t border-gray-200 p-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-red-600 to-red-700 rounded-lg hover:from-red-700 hover:to-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-200 shadow-sm"
            >
        ...
        <div className="flex flex-col flex-1 bg-white border-r border-gray-200 shadow-sm">
          ...
          <div className="flex items-center h-16 px-6 bg-gradient-to-r from-blue-600 to-blue-700">
            <div className="flex items-center">
              ...
              <h1 className="ml-3 text-lg font-bold text-white">Sistema de Horarios</h1>
            </div>
          </div>
      ...
      <div className="md:pl-64 flex flex-col min-h-screen">
        ...
        <div className="sticky top-0 z-10 md:hidden bg-white border-b border-gray-200 shadow-sm">
          <div className="flex items-center justify-between h-16 px-4">
            ...
            <h1 className="text-lg font-semibold text-gray-900">Sistema de Horarios</h1>
            <button
              onClick={handleLogout}
              className="p-2 rounded-lg text-red-600 hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
              </svg>
        ...
        <footer className="bg-white border-t border-gray-200 py-4 px-4 sm:px-6 lg:px-8">
          <div className="text-center text-sm text-gray-500">
            © 2025 Sistema de Gestión de Horarios - Universidad
          </div>
        </footer>
      </div>
    </div>
