...
const Create = () => {
  ...
  const loadFormData = async () => {
    try {
      setLoadingForm(true);
      const data = await docenteService.getFormData();
      setUsuarios(data.usuarios || []);
    } catch (error) {
      console.error('Error al cargar datos del formulario:', error);
      setErrors({ form: 'Error al cargar los usuarios disponibles.' });
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.response?.data?.errors) {
        ...
        setErrors({ form: 'Error al crear el docente. Por favor, intenta nuevamente.' });
      }
    } finally {
      setLoading(false);
    }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5">
            ...
            <p className="text-blue-100 text-sm mt-1">Complete los datos del nuevo docente</p>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    maxLength={100}
                    placeholder="Ej: Jefe de Departamento, Coordinador"
                    className={`w-full px-4 py-2.5 rounded-lg border ${
                      errors.cargo
                        ? 'border-red-300 bg-red-50 focus:ring-red-500 focus:border-red-500'
                        : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
